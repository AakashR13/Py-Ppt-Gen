                                ...
                                try:
                                    ...
                                    if "picture" in existing_name.lower() and content != "No content available":
                                        ...
                                        image_response = requests.post(
                                            ...
                                            headers={"Content-Type": "application/json", "Authorization": f"Bearer {LLMF_TOK}:imggen"},
                                            json={
                                                "model": "dall-e-3",
                                                "prompt": content,
                                                "n": 1,
                                        ...
                                        if image_response.status_code == 200:
                                            ...
                                            if img_response.status_code == 200:
                                                ...
                                                st.warning(f"Failed to download image from URL for '{placeholder_name}' on slide {slide_number + 1}.")
                                        else:
                                            st.warning(f"Failed to generate image for '{placeholder_name}' on slide {slide_number + 1}.")
                                    else:
